...
2026-03-05 16:27:01,967 DEBUG WAIT image: get NewMessage event_bot: NewMessage.Event(original_update=UpdateNewMessage(
message=Message(id=8241, peer_id=PeerUser(user_id=7113450139), date=datetime.datetime(2026, 3, 5, 13, 27, 1, tzinfo=datetime.timezone.utc), 
                message='', 
                out=False, 
                mentioned=False, 
                media_unread=False, 
                ...
                media=MessageMediaPhoto(
                    spoiler=False, 
                    photo=Photo(
                        id=5280719937943049675, 
                        access_hash=-3718190635091126739, 
                        file_reference=b'\x01\x00\x00 1i\xa9\x84\xa5C^\xe2\xfb\xef\x97\x13\xcc&\xf5\xb6,\x9f$\x91p', 
                        date=datetime.datetime(2026, 3, 5, 13, 7, 37, 
                                               tzinfo=datetime.timezone.utc), 
                                               sizes=[PhotoSize(type='s', w=40, h=90, size=760), 
                                                      PhotoSize(type='m', w=143, h=320, size=9727), 
                                                      PhotoSize(type='x', w=358, h=800, size=38599), 
                                                      PhotoSizeProgressive(type='y', w=573, h=1280, sizes=[7520, 16565, 29588, 48091, 64504])], 
                                                      dc_id=2, 
                                                      has_stickers=False, 
                                                      video_sizes=[]), 
                                                      ttl_seconds=None), 
                                                      ...
                                                      message=Message(
                                                          id=8241, 
                                                          peer_id=PeerUser(user_id=7113450139), 
                                                          date=datetime.datetime(2026, 3, 5, 13, 27, 1, tzinfo=datetime.timezone.utc), 
                                                          message='', 
                                                          out=False, 
                                                          mentioned=False, 
                                                          media_unread=False, 
                                                          ...
                                                          via_business_bot_id=None, 
                                                          reply_to=None, 
                                                          media=MessageMediaPhoto(spoiler=False, p
                                                                                  hoto=Photo(id=5280719937943049675, 
                                                                                             access_hash=-3718190635091126739, 
                                                                                             file_reference=b'\x01\x00\x00 1i\xa9\x84\xa5C^\xe2\xfb\xef\x97\x13\xcc&\xf5\xb6,\x9f$\x91p', 
                                                                                             date=datetime.datetime(2026, 3, 5, 13, 7, 37, tzinfo=datetime.timezone.utc), 
                                                                                             sizes=[PhotoSize(type='s', w=40, h=90, size=760), 
                                                                                                    PhotoSize(type='m', w=143, h=320, size=9727), 
                                                                                                    PhotoSize(type='x', w=358, h=800, size=38599), 
                                                                                                    PhotoSizeProgressive(type='y', w=573, h=1280, sizes=[7520, 16565, 29588, 48091, 64504])], 
